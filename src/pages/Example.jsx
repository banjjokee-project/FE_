...
const Example = () => {
    ...
    return (
      <div className="">
        ...
        <button className="btn btn-outline outline outline-1 ml-36 mx-4 h-14 w-40 justify-center" onClick={() => navigate("/walking")}>산책 달력 페이지</button>
        ...
        <button className="btn btn-outline outline outline-1 mr-36 mx-4 h-14 w-40 justify-center" onClick={() => navigate("/board")}>게시판 페이지</button>
      </div>
    );
  };
